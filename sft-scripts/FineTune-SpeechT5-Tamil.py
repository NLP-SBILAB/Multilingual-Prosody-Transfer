...
# Load the Tamil dataset from Common Voice
dataset = load_dataset("mozilla-foundation/common_voice_11_0", "ta", split="train")
...
training_args = Seq2SeqTrainingArguments(
    output_dir="speecht5_finetuned_common_voice_tamil",
